...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    private Notification buildNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, notificationIntent, com.termux.shared.notification.NotificationUtils.getPendingIntentFlags(0, false));
        ...
        builder.addAction(android.R.drawable.ic_delete, res.getString(R.string.notification_action_exit), PendingIntent.getService(this, 0, exitIntent, com.termux.shared.notification.NotificationUtils.getPendingIntentFlags(0, false)));
        ...
        builder.addAction(actionIcon, actionTitle, PendingIntent.getService(this, 0, toggleWakeLockIntent, com.termux.shared.notification.NotificationUtils.getPendingIntentFlags(0, false)));
